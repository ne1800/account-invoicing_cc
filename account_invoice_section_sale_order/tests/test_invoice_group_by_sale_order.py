...
class TestInvoiceGroupBySaleOrder(SavepointCase):
    ...
    def test_custom_grouping_by_sale_order_user(self):
        ...
        section_grouping_func = "odoo.addons.account_invoice_section_sale_order.models.account_move.AccountMoveLine._get_section_grouping"  # noqa
        section_name_func = (
            "odoo.addons.base.models.res_users.Users._get_invoice_section_name"
        )
        with mock.patch(
            section_grouping_func
        ) as mocked_get_section_grouping, mock.patch(
            section_name_func, create=True
